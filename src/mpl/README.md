...
| `-create_regions_for_std_cells` | Create region constraints for the std cells using the clusters of the physical hierarchical tree generated during macro placement. Requires `-keep_clustering_data`. |
